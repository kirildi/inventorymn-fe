    ...
    rsx! {
        ul {
            ...
            for prj in props.project_list{
                li {
                    id: "{prj.project_id}",
                    class: "projects__wrapper flex flex-nowrap items-center w-full h-16 mb-4 rounded-md bg-neutral-800 border-2",
                    div {
                        class: "project__name w-2/3 self-start h-auto p-4 border-r-2",
                        "{prj.project_name}"
                    },
                }
            }
