...
pub fn LocationsPage() -> Element {
    ...
    // TODO this hardcoded id is used while developing, should be removed on all places
    ...
    rsx! {
        section {
            class: "locations__section flex flex-row flex-wrap gap-4 h-[34rem] p-4 text-xl rounded-xl bg-neutral-900",
            {locations_wrapper}
        }
    }
}
